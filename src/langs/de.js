const de = {
    pages: {
        ...
        checkout: {
            ...
            forms: {
                ...
                payment: {
                    ...
                    paypal: "PayPal",
                    card: {
                        first: "Nach dem Klick auf",
                        second: "wirst du weitergeleitet zu",
                        third: "um deinen Kauf sicher abzuschließen."
                    }
                },
        ...
        login: {
            ...
            forgotPassword: {
                ...
                link: "Passwort wiederherstellen"
            }
        },
        register: {
            headTitle: "Konto registrieren",
    ...
    product: {
        ...
        removeFilters: {
            text: "Verwenden Sie weniger Filter oder",
            button: "löschen Sie sie alle"
        },
        filters: {
