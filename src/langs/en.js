const en = {
        ...
        checkout: {
            ...
            forms: {
                ...
                payment: {
                    ...
                    paypal: "PayPal",
                    card: {
                        first: "After clicking",
                        second: "you will be redirected to",
                        third: "to securely complete your purchase."
                    }
                },
    ...
    product: {
        ...
        removeFilters: {
            text: "Use fewer filters or",
            button: "delete them all"
        },
        filters: {
