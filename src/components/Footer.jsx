        ...
        <footer className={"flex flex-col items-center border-t"}>
            ...
            <div className={"flex flex-col gap-20 w-full"}>
                ...
                <div className={"border-t py-2 text-center w-full"}>
                    <span className={"text-sm text-neutral-600"}>© 2023 Salon Wigs Eloisa made by <Link target={"_blank"} className={"text-violet-800 underline"} href={"https://helphistech.com"}>HelphisTech</Link></span>
                </div>
            </div>
        </footer>
    )
